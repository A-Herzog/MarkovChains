# How to build a desktop app of the Markov chain simulator

The Markov chain simulator can be used as a web service.
To use the service just go to

**[a-herzog.github.io/MarkovChains](https://a-herzog.github.io/MarkovChains/)**

The Markov chain simulator can also be built to a exe file. Neutralinojs is used for building the standalone app.
...
2. Run `0_Prepare.bat` to add the Neutralinojs files to the MarkovChains folder.
